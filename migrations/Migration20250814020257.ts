...
export class Migration20250814020257 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `create table "post" ("id" serial primary key, "title" varchar(255) not null, "author_id" int not null);`,
    );

    this.addSql(
      `create table "post_tags" ("post_id" int not null, "tag_id" int not null, constraint "post_tags_pkey" primary key ("post_id", "tag_id"));`,
    );
